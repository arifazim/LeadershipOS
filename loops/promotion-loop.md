...
- A candidate's readiness score crosses the threshold in `skills/career/promotion/promotion-readiness.md` or the EM-side tracking in `skills/performance/promotion-readiness.md`
...
- **Hidden candidate**: a ready candidate never submitted because the EM didn't initiate — see `skills/performance/promotion-readiness.md`'s "hidden candidate" signal
